...
const programs = [
    {
        id: 1,
        title: 'Formação de Educadores STEAM',
        description: 'Programa completo para capacitar educadores a ministrar oficinas de robótica e circuitos elétricos com metodologia ativa.',
        duration: '40 horas',
        format: 'Online + Presencial',
        modules: ['Fundamentos STEAM', 'Robótica Educacional', 'Circuitos Elétricos', 'Metodologia Ativa', 'Inclusão de Meninas'],
    },
    {
        id: 2,
        title: 'Workshop Intensivo de Robótica',
        description: 'Imersão prática em robótica educacional com projetos reais e hands-on.',
        duration: '20 horas',
        format: 'Presencial',
        modules: ['Montagem de Robôs', 'Programação', 'Projetos Práticos', 'Troubleshooting'],
    },
    {
        id: 3,
        title: 'Especialização em Circuitos Elétricos',
        description: 'Aprofundamento em eletrônica e circuitos para educadores e entusiastas.',
        duration: '30 horas',
        format: 'Online',
        modules: ['Eletricidade Básica', 'Componentes Eletrônicos', 'Projetos Avançados', 'Segurança'],
    },
];
